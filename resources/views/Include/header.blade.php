                ...
                <div class="col-lg-10 col-md-8 text-center text-lg-right text-md-right">
                    <div class="header-top-info mb-2 mb-md-0">
                        ...
                        <a href="mailto:support@gmail.com"><i
                                class="fas fa-envelope mr-2"></i><span>support@cursorsoft.com</span></a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <nav class="navbar navbar-expand-lg px-0 py-4">
                        ...
                        <div class="collapse navbar-collapse text-center" id="navbarsExample09">
                            <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item {{ Route::is('front.service') ? 'active' : '' }}">
                                    <a class="nav-link" href="{{ route('front.service') }}">Services</a>
                                </li>
                                <li class="nav-item {{ Route::is('front.project') ? 'active' : '' }}">
                                    <a class="nav-link" href="{{ route('front.project') }}">Portfolio</a>
                                </li>
                                ...
                                <li class="nav-item {{ Route::is('front.contact') ? 'active' : '' }}">
